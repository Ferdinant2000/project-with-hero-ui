...
import securityLevels from "@/pages/CardsTab/interactive-slider/slider-level/Data-SecurityLevelSlider";
                    ...
                    <div className="light grid md:grid-cols-2 gap-6 mb-6">
                        <div className="bg-success-50 p-4 rounded-lg">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span className="font-bold text-success-700">{data?.protection}</span>
                            </div>
                        </div>
                        <div className="bg-blue-50 p-4 rounded-lg">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span className="font-bold text-blue-700">{data?.performance}</span>
                            </div>
                        </div>
                    </div>
                </div>
