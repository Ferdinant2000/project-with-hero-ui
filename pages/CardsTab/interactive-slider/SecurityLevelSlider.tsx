            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                <div className="max-w-4xl mx-auto">
                    <div className="flex items-center justify-between mb-6">
                        <span className="text-sm font-medium text-gray-600">Minimal Security</span>
                        <span className="text-sm font-medium text-gray-600">Maximum Security</span>
                    </div>
                    <div className="relative mb-8">
                        <input
                            ...
                            style={{
                                background: 'linear-gradient(to right, rgb(239, 68, 68) 0%, rgb(249, 115, 22) 25%, rgb(234, 179, 8) 50%, rgb(34, 197, 94) 75%, rgb(59, 130, 246) 100%)'
                            }}
                        />
                    ...
                    <div className="text-center p-6 rounded-lg transition-all duration-300">
                        ...
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Minimal Security</h3>
                        <p className="text-gray-600 mb-4">Basic packet filtering with minimal rules</p>
                        <div className="light grid md:grid-cols-2 gap-6 mb-6">
                            <div className="bg-success-50 p-4 rounded-lg">
                                <h4 className="font-semibold text-success-700 mb-2">Security Level</h4>
                            ...
                            <div className="bg-blue-50 p-4 rounded-lg">
                                <h4 className="font-semibold text-blue-700 mb-2">Performance Impact</h4>
                                <div className="flex items-center justify-between">
